...
public class UniWebView: MonoBehaviour {
    ...
    void Awake() {
        ...
        OnPageStarted += (browser, url) =>
        {
            ...
            ReferenceRectTransform.anchorMin = anchorMin;
            ReferenceRectTransform.anchorMax = anchorMax;
    ...
    private RectTransform CreateCanvas()
    {
        ...
        var _rectTransform = rect.GetComponent<RectTransform>();
